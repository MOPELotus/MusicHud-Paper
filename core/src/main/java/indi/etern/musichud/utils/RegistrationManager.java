...
public class RegistrationManager {
    ...
    private static final String[] SERVER_REGISTRIES = new String[]{
            "indi.etern.musichud.server.api.PlayerSessionRegistry",
    ...
    private static final String[] COMMON_REGISTRIES = new String[]{
            ...
            "indi.etern.musichud.network.payloads.requestResponseCycle.TuneWeaveControlRequest$RegisterImpl",
            "indi.etern.musichud.network.payloads.requestResponseCycle.TuneWeaveControlResponse$RegisterImpl",
